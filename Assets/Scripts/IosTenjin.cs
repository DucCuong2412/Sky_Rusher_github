...
public class IosTenjin : BaseTenjin
{
	...
	{
		UnityEngine.Debug.Log("iOS Initializing " + apiKey);
		base.ApiKey = apiKey;
	}

	public override void Init(string apiKey, string sharedSecret)
	{
		UnityEngine.Debug.Log("iOS Initializing with Shared Secret" + apiKey);
		base.ApiKey = apiKey;
	...
	{
		UnityEngine.Debug.Log("iOS Connecting " + base.ApiKey);
	}
